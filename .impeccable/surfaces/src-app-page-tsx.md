...
related_targets: ["src/components/site-header.tsx","src/components/site-footer.tsx","src/app/layout.tsx"]
---

# Home landing

- Mode: Persuade. Visitor: high-volume reader who already fails at re-finding, arriving before the product ships.
- Job: understand why this exists, see the loop (capture / ask / sources), know it is coming soon.
- Action: none. No waitlist. Close is “Coming soon.”
